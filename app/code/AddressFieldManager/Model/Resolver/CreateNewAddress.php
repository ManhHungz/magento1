...
class CreateNewAddress
{
    ...
    public function __construct(
        \Magento\CustomerGraphQl\Model\Customer\Address\GetAllowedAddressAttributes $getAllowedAddressAttributes,
        \Magento\Customer\Api\Data\AddressInterfaceFactory $addressFactory,
        \Magento\Customer\Api\AddressRepositoryInterface $addressRepository,
        DirectoryData $directoryData,
        RegionCollectionFactory $regionCollectionFactory,
        \Magento\CustomerGraphQl\Model\Customer\Address\ValidateAddress $addressValidator,
        \Magento\CustomerGraphQl\Model\Customer\Address\PopulateCustomerAddressFromInput $populateCustomerAddressFromInput
    ) {
